 ...
 * */
	...
	public void onClick(View view) {
		...
		case R.id.current_weather_report_text:
			//实时天气预报
			Intent intent=new Intent(StartActivity.this,CurrentWeatherReportActivity.class);
			startActivity(intent);
			break;
		case R.id.future_weather_report_text:
			//未来三天天气预报
			Intent forcastIntent=new Intent(StartActivity.this,FutureWeatherReportActivity.class);
			startActivity(forcastIntent);
			break;
		case R.id.location_net_method_text:
			//网络定位（Wifi+基站）
			Intent netIntent=new Intent(StartActivity.this,NetLocationActivity.class);
			startActivity(netIntent);
			break;
		case R.id.location_multy_method_text:
			//混合定位
			Intent multyIntent=new Intent(StartActivity.this,MultyLocationActivity.class);
			startActivity(multyIntent);
			break;
		case R.id.location_gps_method_text:
			//GPS 定位
			Intent gpsIntent=new Intent(StartActivity.this,GPSLocationActivity.class);
			startActivity(gpsIntent);
			break;
		case R.id.location_geofence_method_text:
			//地理围栏
			Intent geoFenceIntent=new Intent(StartActivity.this,GeoFenceActivity.class);
